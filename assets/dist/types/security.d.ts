...
export type SecurityEventType = 'file_opened' | 'file_closed' | 'copy_attempt' | 'screenshot_attempt' | 'print_attempt' | 'download_attempt' | 'context_menu_blocked' | 'dev_tools_detected' | 'visibility_changed' | 'session_expired';
/**
 * ===========================================
 ...
 */
export declare const MAX_SECURITY_CONFIG: SecurityConfig;
